...
def test_vault_builder_creates_expected_files(tmp_path, monkeypatch):
    ...
    assert (tmp_path / "cves" / "CVE-2024-12345.md").exists()
    ...
    cve_note = (tmp_path / "cves" / "CVE-2024-12345.md").read_text(encoding="utf-8")
    assert "# CVE-2024-12345" in cve_note
